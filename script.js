...
function createEditorHeader() {
    ...
    textContainer.innerHTML = `Mode édition`;

    editorHeader.appendChild(svgContainer);
    editorHeader.appendChild(textContainer)
